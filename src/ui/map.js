/**
 * Карта в секции «Адреса». Leaflet + цветные тайлы Esri World Street Map.
 *
...
/**
 * Тайлы Esri World Street Map: цветная подложка без ключа — дороги, парки,
 * вода, подписи по-русски. Серый Light Gray Canvas, стоявший здесь раньше,
 * сливался с фоном страницы, и две точки на нём было не найти.
 *
 ...
 *
 * Атрибуция обязательна и лежит в разметке под картой. У World Street Map
 * данные не из OpenStreetMap, поэтому подпись только Esri: чужой копирайт
 * под чужими тайлами хуже, чем никакого.
 */
const TILE_URL =
